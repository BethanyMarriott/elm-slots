...
var author$project$Config$Seven = {$: 'Seven'};
var author$project$Model$initialModel = {bet: 5, credits: 100, reelOne: author$project$Config$Seven, reelThree: author$project$Config$Seven, reelTwo: author$project$Config$Seven, winningDogs: 0};
var author$project$Msg$SetReelOne = function (a) {
	return {$: 'SetReelOne', a: a};
};
var author$project$Msg$SetReelThree = function (a) {
	return {$: 'SetReelThree', a: a};
};
var author$project$Msg$SetReelTwo = function (a) {
	return {$: 'SetReelTwo', a: a};
};
var author$project$Config$Five = {$: 'Five'};
var author$project$Config$Four = {$: 'Four'};
var author$project$Config$One = {$: 'One'};
var author$project$Config$Six = {$: 'Six'};
var author$project$Config$Three = {$: 'Three'};
var author$project$Config$Two = {$: 'Two'};
...
var author$project$Update$reelOne = A2(
	elm$random$Random$weighted,
	_Utils_Tuple2(10, author$project$Config$One),
	_List_fromArray(
		[
			_Utils_Tuple2(10, author$project$Config$Two),
			_Utils_Tuple2(10, author$project$Config$Three),
			_Utils_Tuple2(10, author$project$Config$Four),
			_Utils_Tuple2(15, author$project$Config$Five),
			_Utils_Tuple2(40, author$project$Config$Six),
			_Utils_Tuple2(5, author$project$Config$Seven)
		]));
var author$project$Update$reelThree = A2(
	elm$random$Random$weighted,
	_Utils_Tuple2(10, author$project$Config$One),
	_List_fromArray(
		[
			...
			_Utils_Tuple2(10, author$project$Config$Three),
			_Utils_Tuple2(10, author$project$Config$Four),
			_Utils_Tuple2(10, author$project$Config$Five),
			_Utils_Tuple2(10, author$project$Config$Six),
			_Utils_Tuple2(40, author$project$Config$Seven)
		]));
var author$project$Update$reelTwo = A2(
	elm$random$Random$weighted,
	_Utils_Tuple2(10, author$project$Config$One),
	_List_fromArray(
		[
		...
		switch (msg.$) {
			case 'Spin':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{credits: model.credits - model.bet, winningDogs: 0}),
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2(elm$random$Random$generate, author$project$Msg$SetReelOne, author$project$Update$reelOne),
								A2(elm$random$Random$generate, author$project$Msg$SetReelTwo, author$project$Update$reelTwo),
								A2(elm$random$Random$generate, author$project$Msg$SetReelThree, author$project$Update$reelThree)
							])));
			case 'IncreaseBet':
				var increase = function () {
					var _n1 = _Utils_eq(model.credits, model.bet);
					if (_n1) {
						return model.bet;
					} else {
						return model.bet + 5;
			...
			case 'SetReelOne':
				var reel = msg.a;
				var winningDogs = _Utils_eq(reel, author$project$Config$Seven) ? (model.winningDogs + 1) : model.winningDogs;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							credits: (winningDogs === 3) ? (model.credits * 100) : model.credits,
							reelOne: reel,
...
var author$project$Msg$DecreaseBet = {$: 'DecreaseBet'};
var author$project$Msg$IncreaseBet = {$: 'IncreaseBet'};
var author$project$Msg$MaxBet = {$: 'MaxBet'};
var author$project$Msg$MinBet = {$: 'MinBet'};
var author$project$Msg$Spin = {$: 'Spin'};
var author$project$Msg$StartOver = {$: 'StartOver'};
...
var author$project$View$playButtons = function (model) {
	var _n0 = model.credits > 0;
	if (_n0) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-lg btn-block btn-success'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$Spin)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Spin '),
									...
									_List_fromArray(
										[
											...
											'(' + (elm$core$String$fromInt(model.bet) + ' Credits)'))
										]))
								])),
							A2(rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
							A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-sm btn-warning mr-2'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$MinBet)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Min Bet')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$button,
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-sm btn-warning mr-2'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$DecreaseBet)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('- Bet')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$button,
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-sm btn-warning mr-2'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$IncreaseBet)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('+ Bet')
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-sm btn-warning mr-2'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$MaxBet)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Max Bet')
								]))
						]))
				]));
	} else {
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('btn btn-success btn-lg'),
									rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$StartOver)
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Start Over')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Oops, you\'re out of credits! Game Over.')
								]))
						]))
				]));
	}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$class('modal fade'),
						A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'tabindex', '-1'),
						A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'role', 'dialog'),
						A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-labelledby', 'exampleModalLabel'),
						A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-hidden', 'false')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$class('modal-dialog'),
								rtfeldman$elm_css$Html$Styled$Attributes$id('exampleModal'),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$text('Congratulations!')
											])),
										A2(
										rtfeldman$elm_css$Html$Styled$div,
										_List_fromArray(
										...
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$text('stuff')
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$class('col-12')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$class('card mt-4')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$text('Slots Game')
											])),
										A2(
										rtfeldman$elm_css$Html$Styled$div,
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$Attributes$class('card-block p-3')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$Attributes$class('col d-flex align-items-center justify-content-center')
															]),
														_List_fromArray(
															[
																A2(
																...
																_List_fromArray(
																	[
																		...
																		author$project$Config$reelToImageSrc(model.reelOne)),
																		A2(rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '250px')
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$src(
																		author$project$Config$reelToImageSrc(model.reelTwo)),
																		A2(rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '250px')
																	]),
																_List_Nil)
															])),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$src(
																		author$project$Config$reelToImageSrc(model.reelThree)),
																		A2(rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '250px'),
														...
														_List_fromArray(
															[
																author$project$View$playButtons(model),
																A2(
																rtfeldman$elm_css$Html$Styled$div,
																_List_fromArray(
																	[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				rtfeldman$elm_css$Html$Styled$text(
																				'Current Bet: ' + (elm$core$String$fromInt(model.bet) + ' Credits'))
																			])),
																		A2(rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
																		A2(
																		rtfeldman$elm_css$Html$Styled$small,
																		...
																		_List_fromArray(
																			[
																				rtfeldman$elm_css$Html$Styled$text(
																				'Credits: ' + elm$core$String$fromInt(model.credits))
																			]))
																	]))
															]))
													]))
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$Attributes$class('card-block p-4')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														rtfeldman$elm_css$Html$Styled$text('blah')
													]))
											]))
									]))
							]))
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Msg.Msg","aliases":{},"unions":{"Msg.Msg":{"args":[],"tags":{"Spin":[],"MaxBet":[],"MinBet":[],"IncreaseBet":[],"DecreaseBet":[],"SetReelOne":["Config.Reel"],"SetReelTwo":["Config.Reel"],"SetReelThree":["Config.Reel"],"StartOver":[]}},"Config.Reel":{"args":[],"tags":{"One":[],"Two":[],"Three":[],"Four":[],"Five":[],"Six":[],"Seven":[]}}}}})}});}(this));