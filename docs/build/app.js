...
{
	if (region.a3.av === region.bm.av)
	{
		return 'on line ' + region.a3.av;
	}
	return 'on lines ' + region.a3.av + ' through ' + region.bm.av;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b4: 'hidden', b_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b4: 'mozHidden', b_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b4: 'msHidden', b_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b4: 'webkitHidden', b_: 'webkitvisibilitychange' }
		: { b4: 'hidden', b_: 'visibilitychange' };
}
...
var author$project$Config$Five = 4;
var author$project$Config$Four = 3;
var author$project$Config$One = 0;
var author$project$Config$Six = 5;
var author$project$Config$Three = 2;
var author$project$Config$Two = 1;
		...
		switch (msg.$) {
			...
			case 3:
				var increase = function () {
					var _n1 = _Utils_eq(model.bj, model.bc);
					if (_n1) {
						return model.bc;
					} else {
						return model.bc + 5;
			...
			case 5:
				var reel = msg.a;
				var winningDogs = (reel === 6) ? (model.bU + 1) : model.bU;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bj: (winningDogs === 3) ? (model.bj * 100) : model.bj,
							bH: reel,
							bU: winningDogs
						}),
					elm$core$Platform$Cmd$none);
...
var author$project$Msg$IncreaseBet = {$: 3};
var author$project$Msg$MaxBet = {$: 1};
var author$project$Msg$MinBet = {$: 2};
var author$project$Msg$Spin = {$: 0};
var author$project$Msg$StartOver = {$: 8};
								...
								[
									...
									_List_fromArray(
										[
											...
											'(' + (elm$core$String$fromInt(model.bc) + ' Credits)'))
										]))
								])),
							A2(rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
							A2(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		author$project$Config$reelToImageSrc(model.bH)),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$src(
																		author$project$Config$reelToImageSrc(model.bJ)),
																		A2(rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '250px')
																	]),
																_List_Nil)
															])),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$src(
																		author$project$Config$reelToImageSrc(model.bI)),
																		A2(rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '250px'),
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				rtfeldman$elm_css$Html$Styled$text(
																				'Current Bet: ' + (elm$core$String$fromInt(model.bc) + ' Credits'))
																			])),
																		A2(rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
																		A2(
																		rtfeldman$elm_css$Html$Styled$small,
																		...
																		_List_fromArray(
																			[
																				rtfeldman$elm_css$Html$Styled$text(
																				'Credits: ' + elm$core$String$fromInt(model.bj))
																			]))
																	]))
															]))
													]))
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bp: fragment, bq: host, bz: path, bB: port_, bE: protocol, bF: query};
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bi: elm$core$Maybe$Nothing, br: _List_Nil, bx: _List_Nil, bN: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	var charset = _n0.bi;
	var imports = _n0.br;
	var namespaces = _n0.bx;
	var snippets = _n0.bN;
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bi: charset, b0: declarations, br: imports, bx: namespaces};
};
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bi: charset, b0: finalDeclarations, br: imports, bx: namespaces};
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		...
		cn: A2(elm$core$Basics$composeR, author$project$View$view, rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
